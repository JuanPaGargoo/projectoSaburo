...
function NewsLetterSection() {
  return (
    ...
    <div className='bg-cafeCacao flex flex-row items-center justify-center gap-5 w-[70%] h-[150px] rounded-3xl'>
        ...
        <div className='flex flex-col items-center justify-center gap-5 mt-4 pb-8 w-[50%] p-6'>
          <div className='w-full'>
            <Input
              ...
              className='w-full'
            />
            <Button size="md" className='w-full mt-4 bg-gray-100 font-lato font-bold text-cafeCacao'>Subscribe to Newsletter</Button>
          </div>
        </div>
    </div>
    </div>
